...
7:["$","$1","c",{"children":[["$","div",null,{"className":"min-h-screen bg-white flex items-center justify-center","children":["$","div",null,{"className":"text-center","children":[["$","h1",null,{"className":"text-4xl font-bold text-black mb-4","children":"Test Page"}],["$","p",null,{"className":"text-gray-600","children":"If you can see this, Next.js is working!"}],["$","a",null,{"href":"/","className":"text-blue-500 hover:underline mt-4 block","children":"Go back to main page"}]]}]}],null,["$","$La",null,{"children":["$Lb",["$","$Lc",null,{"promise":"$@d"}]]}]]}]
