...
export default function InstagramFeed() {
  ...
  return (
    <section className="py-8 bg-beige-light">
      <div className="container-minimal">
        <div className="text-center">
          <h2 className="text-headline font-light mb-2">Follow Our Journey</h2>
          <p className="text-sm text-gray-500 mb-4">Follow @valdoamericas</p>
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm">
            {hasError ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">Follow @valdoamericas</h3>
                <p className="text-sm text-gray-500 mb-4 max-w-md mx-auto">
                  Get the latest updates and exclusive offers from Valdo Americas.
                </p>
                <a 
